...
(`app/**/page.js`), do script SQL completo (schema + seeds + view + procedure
+ triggers) e deste README, a partir da especificação do projeto e do script
SQL fornecidos pelo professor. Todo o código gerado foi revisado pelo grupo
antes do envio.
